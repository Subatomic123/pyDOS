...
def internet():
    print("Modems near you:")
    print("AT&T47")
    print("1234")
    for i in range(1):
        loginet = input("Choose net:")
        if loginet.lower() == "1234":
            state["internet"] = True
            print("Connected!")
        else:
...
def kernel_panic():
                   ...
                   print("\033[31mSYSTEM SERVER CRASHED\033[0m")
                   print("\033[32mP y D O S\033[0m")
                   print("code: krnl_panic")
                   while True:
                       time.sleep(1)
...
def devtool():
    ...
    while True:
        ...
        if user2.lower() == "bootloop":
            bootloop()
        if user2.lower() == "help":
            print("bootloop, hardbrick, exit, help, krnlpnc, syshalt")
        if user2.lower() == "exit":
            break
        if user2.lower() == "krnlpnc":
            kernel_panic()
        if user2.lower() == "syshalt":
            syshalt()
...
def DOS():
    ...
    while True:
        ...
        if user.lower() == "sysinfo":
            ...
            print("Opening...")
            devtool()
        elif user.lower() == "internet":
            internet()
        
        if "/krnl/" not in filesys:
            kernel_panic()
